...
/**
 * A helper, internal info structure that acts as a map but also allows getting / removing
...
.directive('tabContentTransclude', function() {
  ...
  function isTabHeading(node) {
    return node.tagName &&  (
      ...
      node.hasAttribute('info-tab-heading') ||
      node.tagName.toLowerCase() === 'tab-heading' ||
      node.tagName.toLowerCase() === 'info-tab-heading'
    );
  }
})
 ...
 */
  ...
  return {
    ...
    link:function (originalScope, element, attrs, modelCtrl) {
      ...
      //with typeahead-specific info (matches, query etc.)
